...
The dataset contains 18979 rows and 77 columns. The data file also include a data dictionary to further give the data analyst more insight on the players' information.
